...
<div class="wrapper">
  <div class="desktop-layout">
    ...
    <div class="info-slot">
      ...
      >
        <code class="install-text" aria-label="go install github.com/almonk/bontree at latest">
          ...
          <span class="tok-ver">@latest</span>
        </code>
        <button
          class="copy-btn"
          type="button"
      ...
      <section class="readme-snippet desktop-about" aria-label="About bontree">
        <p class="readme-lead">
          Fast, interactive terminal file explorer with fuzzy search, git integration, and Nerd Font icons.
        </p>
        <ul class="readme-list" aria-label="bontree features">
    ...
    <section class="readme-snippet mobile-about" aria-label="About bontree">
      <p class="readme-lead">
        Fast, interactive terminal file explorer with fuzzy search, git integration, and Nerd Font icons.
      </p>
      <ul class="readme-list" aria-label="bontree features">
...
<style>
  ...
  @media (min-width: 901px) {
    ...
    .terminal-slot :global(.terminal-wrapper) {
      border-radius: 6px;
    }
